...
export function Dashboard({
  ...
  return (
    <div className="flex flex-col gap-4 pb-24">
      <div className="rounded-2xl border border-gray-200 bg-white p-4 dark:border-white/10 dark:bg-[#171a22]">
      ...
      <div className="grid grid-cols-2 gap-3">
        <Card className="dark:border-white/10 dark:bg-[#171a22]">
          <CardHeader className="pb-2">
            <CardTitle className="text-sm text-gray-500 dark:text-gray-400">Quick Boons</CardTitle>
          </CardHeader>
          <CardContent>
            <p className="text-2xl font-black">Fast</p>
            <p className="text-xs text-gray-500 dark:text-gray-400">Receipt / Invoice / Quote</p>
          </CardContent>
        </Card>

        <Card className="dark:border-white/10 dark:bg-[#171a22]">
          <CardHeader className="pb-2">
            <CardTitle className="text-sm text-gray-500 dark:text-gray-400">Room Feed</CardTitle>
          </CardHeader>
          <CardContent>
            <p className="text-2xl font-black">Live</p>
            <p className="text-xs text-gray-500 dark:text-gray-400">Chat-style visibility</p>
          </CardContent>
        </Card>
      </div>
        ...
        <CardContent className="pt-5">
          <div className="space-y-3">
            ...
            <Button
              ...
              className="h-12 w-full justify-between dark:border-white/20 dark:bg-transparent"
            >
              <span className="inline-flex items-center gap-2">
